...
<body class="theme-primary">
	...
	<header class="header-light">
		<nav hidden class="nav-white bg-white">
			...
			<ul class="menu">				
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><a href="currency_converter.html">President and Vices</a></li>
						<li><a href="live_coin.html">Senates</a></li>
					</ul>
				</li>
				<li class="dropdown">
					<a href="#">Political Parties</a>
					<ul class="dropdown-menu">
						<li><a href="currency_converter.html">Peoples Democratic Party</a></li>
						<li><a href="live_coin.html">All Progressive Party</a></li>
						
						<li><a href="currency_converter.html">National Peoples Congress</a></li>
						<li><a href="live_coin.html">United Peoples Party</a></li>
			...
			<ul class="attributes">
				<li class="d-md-block d-none"><a href="user.php" class="px-10 pt-15 pb-10"><div class="btn btn-primary py-5">Login</div></a></li>
    ...
    <section class="py-lg-80 py-30 bg-dark3">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-12">
					<div class="text-center">
						<h1 class="box-title text-white mb-20">Global No.1 Business Data Platform</h1>
						<p class="text-white-50 fs-18 mb-30">Insights and facts across 170 industries and 150+ countries</p>
					</div>
					<form class="cours-search mb-30">
						<div class="input-group">
							<input type="text" class="form-control" placeholder="Find statistics, forecasts and studies">
							<div class="input-group-append">
								<button class="btn btn-primary" type="submit">Statista Search</button> 
							</div>
						</div>
					</form>	
				</div>
				<div class="col-lg-6 col-12">							
					<div class="text-center">
						<ul class="list-inline">
							<li><a href="#" class="btn btn-dark btn-sm mb-20">Coronavirus</a></li>
							<li><a href="#" class="btn btn-dark btn-sm mb-20">Covid Vaccine</a></li>
							<li><a href="#" class="btn btn-dark btn-sm mb-20">Social Media</a></li>
							<li><a href="#" class="btn btn-dark btn-sm mb-20">E-Commerce</a></li>
							<li><a href="#" class="btn btn-dark btn-sm mb-20">Smartphone</a></li>
							<li><a href="#" class="btn btn-dark btn-sm mb-20">China</a></li>
							<li><a href="#" class="btn btn-dark btn-sm mb-20">Gaming</a></li>
							<li><a href="#" class="btn btn-dark btn-sm mb-20">Film Industry</a></li>
							<li><a href="#" class="btn btn-dark btn-sm mb-20">United States</a></li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-7 col-12 text-start">
					<h6 class="sub-heading">VOTE NOW</h6>
					<h1 class="mb-15">How To Vote</h1>					
					<hr class="w-100 bg-primary ms-0">
					
					<ul class="nav nav-pills" role="tablist">
						<li class="nav-item"> <a class="nav-link active fs-18 py-15" data-bs-toggle="tab" href="#home7" role="tab">Register</a> </li>
						<li class="nav-item"> <a class="nav-link py-15 fs-18" data-bs-toggle="tab" href="#profile7" role="tab">Check ELigibilty</a> </li>
						<li class="nav-item"> <a class="nav-link py-15 fs-18" data-bs-toggle="tab" href="#messages7" role="tab">Vote</a> </li>
					</ul>
					<!-- Tab panes -->
