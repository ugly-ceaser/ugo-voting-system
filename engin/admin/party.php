...
function getRow(id){
  $.ajax({
    ...
    success: function(response){
      ...
      $('#edit_party_sec').val(response.party_sec);
      $('#edit_party_contact').val(response.party_contact);
      $('#edit_yaer').val(response.yaer);
      $('.party_name').html(response.party_name);
    }
  });
}
</script>
